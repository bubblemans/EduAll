...
function Usercard(){
    const [name,setName]= useState('Rayyan Khan');
    const [userName,setuserName]= useState('Rayyank');
    const [email,setEmail] = useState('Rayyank293@gmail.com')
